    ...
    <section className="py-20 md:py-32 px-6 bg-secondary">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
          Tell us what is slowing the business down, where work is being
          duplicated, what your customers struggle with, or what you wish your
          existing systems could do. We&apos;ll tell you whether technology can
          solve it, what we&apos;d recommend, and what the next step would be.
        </p>
        <WhatsAppLeadTrigger
          size="lg"
